...
var calc;
calc = function (numOne, numTwo, action) { return action == 'add' ? numOne + numTwo : numOne - numTwo; };
var logDetails;
logDetails = function (ninja) { return console.log(ninja.name + " is " + ninja.age + " years old"); };
